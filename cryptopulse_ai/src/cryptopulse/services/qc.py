...
class QualityController:
    ...
    async def review(self, package: ContentPackage) -> QCResult:
        ...
        checks["five_unique_picks"] = (
            len(package.picks) == 5 and len({pick.asset.asset_id for pick in package.picks}) == 5
        )
        ...
        checks["six_hour_horizon"] = "6 hour" in caption_lower or "six-hour" in caption_lower
